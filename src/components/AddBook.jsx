...
function AddBook() {
  ...
  const handleSubmit = (e) => {
    ...
    if (title.trim().length > 2) {
      ...
      setMessage('Text must be at least 3 charaters');
      setTimeout(() => {
        setMessage('');
      }, 2000);
    }
  ...
  return (
    <div className="py-5">
      ...
      <form
        className="py-5 flex gap-5 flex-col justify-between items-center md:flex-row :mdlex-wrap"
      ...
      >
        ...
        <button
          type="submit"
          className="w-full md:w-5/12 bg-blue-500 py-2 text-white rounded-md hover:bg-blue-700 shadow-lg"
        >
          Add
        </button>
      </form>
